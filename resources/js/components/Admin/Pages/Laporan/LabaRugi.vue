      ...
      <v-layout align-space-around justify-center fill-height>
        <v-card width="100%">
          <v-card-title class="justify-center">
            <span class="headline">Laporan Laba/Rugi</span>
          </v-card-title>
          <v-card-title class="justify-center">
          ...
          <v-layout justify-center>
              <table class="border" style="width: 90%">
                ...
                <tfoot class="border">
                    <tr>
                      <th class="border padding" colspan="2"><b>Total Pendapatan Operasional</b></th>
                      <th class="border padding"><b>{{ getTotalDebit }}</b></th>
                  </tr>
                  <tr>
                      <th class="border padding" colspan="2"><b>Total Beban Operasional</b></th>
                      <th class="border padding"><b>{{ getTotalDebit }}</b></th>
                  </tr>
                  <tr>
                      <th class="border padding" colspan="2"><b>Total Beban Non Operasional</b></th>
                      <th class="border padding"><b>{{ getTotalDebit }}</b></th>
                  </tr>
                  <tr>
                      <th class="border padding" colspan="2"><b>Laba Bersih</b></th>
                      <th class="border padding"><b>{{ getTotalDebit }}</b></th>
                  </tr>
                </tfoot>
              </table>
